    ...
    >
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        {step === "select" ? (
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#1919e1] flex items-center gap-2">
                <Plus size={24} className="text-[#1a1ae1]" />
                Select a Template
              </DialogTitle>
              <DialogDescription>
                    ...
                    filteredTemplates.map((template) => (
                      ...
                      >
                        ...
                        {selectedTemplate === template.id && (
                          <div className="absolute top-2 left-2 bg-[#1d3dde] text-white rounded-full p-1">
                            <Check size={14} />
                          </div>
                        )}
          ...
          <>
            ...
            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
              ...
              <Button
                className="bg-[#1c34e6] hover:bg-[#130fe4]"
