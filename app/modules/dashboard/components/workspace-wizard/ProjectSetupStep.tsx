...
import type { MockRepository, ProjectSetupMode } from "./types";
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm leading-6 text-muted-foreground">
                  We&apos;ll send you through GitHub OAuth and reopen this wizard
                  so you can pick a repository right where you left off.
                </p>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div className="space-y-1">
                  <h3 className="text-base font-semibold">Choose a repository</h3>
